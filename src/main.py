...
def sc_herhair_loved(w: World):
    ...
    return w.scene("髪を愛する男",
            ...
            misa.do("彼の手はずっと$Sの髪を撫でている",
                ...
                "でもそれを、彼は愛してくれたのだ"),
            shin.do("$Sは$CSの髪の毛を二つの手で手繰り寄せると、そこに顔を埋めた"),
            misa.talk("恥ずかしいって"),
            shin.talk("裸を見られるより？"),
...
def sc_onthe_day(w: World):
    ...
    return w.scene("式当日",
            ...
            shin.hear("と、ドアが開けられる音が聞こえ、続いて優しい声が響いた"),
...
def sc_eternal_love(w: World):
    ...
    return w.scene("永遠の愛を誓おう",
            ...
            shin.think("病めるときも健やかなるときも、富めるときも貧しいときも、という結婚式を迎える誰もがその心に思い抱く常套句だ",
                "それが牧師の良い声で響き渡る"),
            ...
            shin.do("その呼びかけに答えるように微笑を浮かべて振り返った彼の頭からベールが取れ、そこから長い髪が現れた",
                "$misaoの髪の毛だ",
                "その髪を指に絡め、",
